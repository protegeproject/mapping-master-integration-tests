...
public class OWLAPIRendererIT extends IntegrationTestBase
{
   ...
   @Test
   public void TestClassDeclaration() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestSubClassOf() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestSubClassOfClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestMultipleSubClassOf() throws MappingMasterException, ParseException, IOException
   {
      ...
      assertThat(axioms, containsInAnyOrder(
            Declaration(CAR),
            SubClassOf(CAR, VEHICLE), SubClassOf(CAR, DEVICE)));
   }

   @Test
   public void TestEquivalentToClass() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestEquivalentToClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLObjectProperties(ontology, "hasEngine");
   ...
   @Test
   public void TestMultipleEquivalentClass() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestClassDeclarationWithAnnotations() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestClassDeclarationWithMultipleAnnotations() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestObjectMaxCardinalityRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLObjectProperties(ontology, "hasEngine");
   ...
   @Test
   public void TestObjectMinCardinalityRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLObjectProperties(ontology, "hasEngine");
   ...
   @Test
   public void TestObjectExactCardinalityRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLObjectProperties(ontology, "hasEngine");
      String expression = "Class: Car SubClassOf: hasEngine EXACTLY 1";
   ...
   @Test
   public void TesDatatMaxCardinalityRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TesDatatMinCardinalityRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLDataProperties(ontology, "hasSSN");
   ...
   @Test
   public void TestDataExactCardinalityRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLDataProperties(ontology, "hasSSN");
   ...
   @Test
   public void TestObjectSomeValueRestriction() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDataSomeValueRestriction() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestObjectAllValuesFromRestriction() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDataAllValuesFromRestriction() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestOWLObjectOneOf() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Person");
   ...
   @Test
   public void TestEquivalentToNegatedClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLObjectProperties(ontology, "hasEngine");
   ...
   @Test
   public void TestEquivalentToUnionClassExpression() throws MappingMasterException, ParseException, IOException
   {
      ...
      assertThat(axioms, containsInAnyOrder(
            Declaration(A),
            EquivalentClasses(A, ObjectUnionOf(ObjectExactCardinality(2, HAS_P1, OWLThing()),
                  ObjectExactCardinality(3, HAS_P2, OWLThing())))));
   }

   @Test
   public void TestEquivalentToIntersectionClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "A");
      declareOWLObjectProperties(ontology, "hasP1", "hasP2");
      ...
      assertThat(axioms, containsInAnyOrder(
            Declaration(A),
            EquivalentClasses(A, ObjectIntersectionOf(ObjectExactCardinality(2, HAS_P1, OWLThing()),
                  ObjectExactCardinality(3, HAS_P2, OWLThing())))));
   }
         ...
         throws MappingMasterException, ParseException, IOException
   {
      ...
      assertThat(axioms, containsInAnyOrder(
            Declaration(A),
            EquivalentClasses(A,
                  ObjectIntersectionOf(ObjectComplementOf(ObjectExactCardinality(2, HAS_P1, OWLThing())),
                        ObjectUnionOf(ObjectIntersectionOf(ObjectExactCardinality(3, HAS_P2, OWLThing()),
                              DataMaxCardinality(5, HAS_P4, RDFS_LITERAL)),
                        DataMinCardinality(4, HAS_P3, RDFS_LITERAL))))));
   }

   @Test
   public void TestSubClassOfNegatedClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
      declareOWLObjectProperties(ontology, "hasEngine");
   ...
   @Test
   public void TestSubClassOfUnionClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "A");
      declareOWLObjectProperties(ontology, "hasP1", "hasP2");
      ...
      assertThat(axioms, containsInAnyOrder(
            Declaration(A),
            SubClassOf(A, ObjectUnionOf(ObjectExactCardinality(2, HAS_P1, OWLThing()),
                  ObjectExactCardinality(3, HAS_P2, OWLThing())))));
   }

   @Test
   public void TestSubClassOfIntersectionClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "A");
      declareOWLObjectProperties(ontology, "hasP1", "hasP2");
      ...
      assertThat(axioms, containsInAnyOrder(
            Declaration(A),
            SubClassOf(A, ObjectIntersectionOf(ObjectExactCardinality(2, HAS_P1, OWLThing()),
                  ObjectExactCardinality(3, HAS_P2, OWLThing())))));
   }

   @Test
   public void TestSubClassOfComplexBooleanClassExpression() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "A");
      declareOWLObjectProperties(ontology, "hasP1", "hasP2");
      declareOWLDataProperties(ontology, "hasP3", "hasP4");
   ...
   @Test
   public void TestIndividualDeclaration() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestIndividualDeclarationWithTypes() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Person");
   ...
   @Test
   public void TestIndividualDeclarationWithMultipleTypes() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Person", "Human");
   ...
   @Test
   public void TestIndividualDeclarationWithFacts() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestIndividualDeclarationWithMultipleFacts() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestIndividualDeclarationWithAnnotations() throws MappingMasterException, ParseException, IOException
   {
   ...
   public void TestIndividualDeclarationWithMultipleSameIndividual()
         throws MappingMasterException, ParseException, IOException
   {
      declareOWLNamedIndividuals(ontology, "Freddy", "F");
   ...
   public void TestIndividualDeclarationWithMultipleDifferentIndividuals()
         throws MappingMasterException, ParseException, IOException
   {
      declareOWLNamedIndividuals(ontology, "Bob", "Bobby");
   ...
   @Test
   public void TestAbsoluteReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestAbsoluteIndividualReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestAbsoluteObjectPropertyReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLObjectProperty(ontology, "hasParent");
   ...
   @Test
   public void TestAbsoluteDataPropertyReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestAbsoluteAnnotationPropertyReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestLiteralReference() throws MappingMasterException, ParseException, IOException
   {
      String expression = "Class: @\"Car\"";
      Optional<? extends OWLAPIRendering> result = createOWLAPIRendering(ontology, expression, settings);
      assertThat(result.isPresent(), is(true));
   ...
   @Test
   public void TestAbsoluteReferenceWithSheetName() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestColumnWildcardInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestRowWildcardInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestClassQualifiedInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestIndividualInQualifiedReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Fred", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestObjectPropertyInQualifiedReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLObjectProperty(ontology, "hasParent");
   ...
   @Test
   public void TestDataPropertyQualifiedInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasAge");
   ...
   @Test
   public void TestAnnotationPropertyQualifiedReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLAnnotationProperty(ontology, "hasAge");
   ...
   @Test
   public void TestXSDBooleanInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestXSDByteInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestXSDShortInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasSalary");
   ...
   @Test
   public void TestXSDIntInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasSalary");
   ...
   @Test
   public void TestXSDFloatInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasSalary");
   ...
   @Test
   public void TestXSDDecimalInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasSalary");
   ...
   @Test
   public void TestXSDStringInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasName");
   ...
   @Test
   public void TestXSDDateInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestXSDDateTimeInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasDOB");
   ...
   @Test
   public void TestXSDTimeInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestRDFSLabelAppendInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDefaultAppendInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestRDFSLabelPrependInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClass(ontology, "Truck", "Big Car");
   ...
   @Test
   public void TestDefaultPrependInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "BigCar");
   ...
   @Test
   public void TestShiftUpInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestShiftDownInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestShiftRightInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestShiftLeftInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestReferencesInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestToLowerCaseInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "car");
   ...
   @Test
   public void TestToLowerCaseImplicitInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "car");
   ...
   @Test
   public void TestTrimInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestTrimImplicitInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestPrintfInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDecimalFormatInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDecimalFormatWithBadFormatInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestReverseInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestReverseImplifictInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "Car");
   ...
   @Test
   public void TestToUpperCaseInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "CAR");
   ...
   @Test
   public void TestToUpperCaseImplicitInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClasses(ontology, "CAR");
   ...
   @Test
   public void TestReplaceAllInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasName");
   ...
   @Test
   public void TestCapturingExpressionInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestCapturingExpressionStandaloneInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestCapturingExpressionMethodInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLClass(ontology, "Zyvox", "Zyvox");
   ...
   @Test
   public void TestMultipleCapturingExpressionsInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDefaultLocationValueInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestDefaultLabelInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestResolveIfOWLEntityExistsInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Car", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestSkipIfOWLEntityExistsInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Car", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestWarningIfOWLEntityExistsInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Car", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestErrorIfOWLEntityExistsInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Car", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestCreateIfOWLEntityDoesNotExistInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Car", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestSkipIfOWLEntityDoesNotExistInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("Car", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestErrorIfOWLEntityDoesNotExistInReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestErrorIfEmptyLocationDirectiveInReference() throws MappingMasterException, ParseException, IOException
   {
      thrown.expect(RendererException.class);
   ...
   @Test
   public void TestErrorIfEmptyLiteralDirectiveInReference() throws MappingMasterException, ParseException, IOException
   {
      thrown.expect(RendererException.class);
   ...
   @Test
   public void TestErrorIfEmptyRDFIDDirectiveInReference() throws MappingMasterException, ParseException, IOException
   {
      thrown.expect(RendererException.class);
   ...
   @Test
   public void TestSkipIfEmptyLocationInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasName");
   ...
   @Test
   public void TestSkipIfEmptyLiteralInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasName");
   ...
   @Test
   public void TestSkipIfEmptyRDFSLabelDirectiveInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestSkipIfEmptyRDFIDDirectiveInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestWarningIfEmptyLiteralInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasName");
   ...
   @Test
   public void TestWarningIfEmptyRDFIDDirectiveInReference() throws MappingMasterException, ParseException, IOException
   {
      Label cellA1 = createCell("", 1, 1);
      Set<Label> cells = createCells(cellA1);
   ...
   @Test
   public void TestProcessIfEmptyLiteralInReference() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasName");
   ...
   @Test
   public void TestObjectHasValueRestrictionWithReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestDataHasValueRestrictionWithReference() throws MappingMasterException, ParseException, IOException
   {
   ...
   @Test
   public void TestObjectHasValueRestrictionWithReferenceAndEmptyLocation() throws MappingMasterException, ParseException, IOException
   {
      declareOWLObjectProperty(ontology, "hasHull");
   ...
   @Test
   public void TestDataHasValueRestrictionWithReferenceAndEmptyLocation() throws MappingMasterException, ParseException, IOException
   {
      declareOWLDataProperty(ontology, "hasOrigin");
   ...
   @Test
   public void TestOutOfRangeColumnInReference() throws MappingMasterException, ParseException, IOException
   {
//      thrown.expect(RendererException.class);
//      thrown.expectMessage("Invalid source specification @'Sheet1'!D1 - column D is out of range");
   ...
   @Test
   public void TestOutOfRangeRowInReference() throws MappingMasterException, ParseException, IOException
   {
//      thrown.expect(RendererException.class);
//      thrown.expectMessage("Invalid source specification @'Sheet1'!A3 - row 3 is out of range");
   ...
   @Test
   public void TestInvalidSheetNameInReference() throws MappingMasterException, ParseException, IOException
   {
      thrown.expect(RendererException.class);
   ...
   @Test
   public void TestParseException() throws MappingMasterException, ParseException, IOException
   {
